...
ConstantValue *compileUnsignedConstant(void) {
    ...
    switch (lookAhead->tokenType) {
        ...
        case TK_IDENT:
            ...
            constValue = duplicateConstantValue(checkDeclaredConstant(currentToken->string)->constAttrs->value);
            break;
        case TK_CHAR:
            eat(TK_CHAR);
...
ConstantValue *compileConstant2(void) {
    ...
    switch (lookAhead->tokenType) {
        ...
        case TK_IDENT:
            ...
            constValue = duplicateConstantValue(checkDeclaredIdent(currentToken->string)->constAttrs->value);
            break;
        default:
            error(ERR_INVALID_CONSTANT, lookAhead->lineNo, lookAhead->colNo);
            break;
...
Type *compileType(void) {
    ...
    switch (lookAhead->tokenType) {
        ...
        case TK_IDENT:
            ...
            type = duplicateType(checkDeclaredType(currentToken->string)->typeAttrs->actualType);
            break;
        default:
